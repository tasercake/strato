...
> **Decision recap:** See [Decision 3.5](./03-design-decisions.md#35-phantom-nodes-for-external-symbols) for why we model externals as phantom nodes rather than parsing third-party source.
